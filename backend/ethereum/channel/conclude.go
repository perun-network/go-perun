...
func (a *Adjudicator) ensureConcluded(ctx context.Context, req channel.AdjudicatorReq, subChannels channel.ChannelMap) error {
	...
	if req.Tx.IsFinal {
		...
		err = errors.WithMessage(a.callConclude(ctx, req, subChannels), "calling conclude")
	}
